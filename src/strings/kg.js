const kg = {
  ...
  "who-we-are-info":
  'Кыргыз Республикасынын биринчи айымы Айгүл Жапарованын демилгеси менен түзүлгөн "Үмүт булагы" коомдук фонду бүткүл өлкө боюнча иш жүргүзөт. "Биз биринчи кезекте балдарга жана энелерге жардам берүүгө умтулабыз. Алардын жашоо сапаттын жакшыртуу, коргоо жана потенциалын өнүктүрүү максатын көздөйбүз. Үмүт булагы – эне менен балага тирек". А. Жапарова',
  ...
  "what-we-do-info":
    "Биз бүткүл Кыргызстан боюнча жалгыз бой энелерге, жетим балдарга жана башка калктын аярлуу катмарына жардам беребиз. Биздин ишмердүүлүгүбүздүн жети артыкчылыктуу багыттары:",
  ...
  "join-info":
    "Кыргызстандагы аялдар жана балдар, башка калктын аярлуу топтору өзгөчө колдоого муктаж. Умут булагынын волонтеру же өнөктөшү болуп, биздин коомго жардам берүү демилгесин колдоңуз. ",
