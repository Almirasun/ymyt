const ru = {
  // Navbar
  "navbar-link-main": "Главная",
  "navbar-link-about-us": "О нас",
  "navbar-link-projects": "Проекты",
  "navbar-link-news": "Новости",
  "navbar-link-contacts": "Контакты",
  ...
  "who-we-are-info": "Общественный фонд \"Умут булагы\" под инициативой первой леди Кыргызской Республики Айгуль Жапаровой работает по всей стране. \"Мы стремимся в первую очередь помогать детям и матерям. Улучшать их жизни, защищать и развивать их потенциал. Умут булагы – опора для матери и ребенка.\" –  А. Жапарова.",
  ...
  // What we do
  "what-we-do-title": "Что мы делаем?",
  "what-we-do-info": "Мы помогаем матерям-одиночкам, детям-сиротам и иным уязвимым группам населения по всему Кыргызстану.  Семь приоритетных направлений нашей деятельности:",
  "what-we-do-education": "Образование",
  "what-we-do-education-info":"Доступ к достойному образованию",
  ...
  "what-we-do-rights-info":"Защита основных прав и свобод человека",
  ...
  // donate now
  "donate-now":"Сделать пожертвования сейчас",
  "donate-now-info":"Присоединяйтесь к нам. Будьте опорой для матери и ребенка, уязвимым группам населения в Кыргызстане.",
  "donate-button":"Пожертвовать",
  "donate-button-info" : "Далее вы попадете на защищенную страницу оплаты, где сможете перевести свое пожертвование",
  ...
  "send-request-info":"Общественный фонд «Умут булагы» помогает матерям-одиночкам, детям-сиротам и иным уязвимым группам населения по всей стране в виде материальных и нематериальных благ.",
  "send-request-button":"Отправить",
  "send-request-response": "Спасибо за ваш запрос. Мы рассмотрим и свяжемся с вами при первой возможности.",

  // join ymyt
  "join":"Присоединиться к Умγт булагы",
  "join-info":"Женщины и дети, другие социально уязвимые группы Кыргызстана особенно нуждаются в поддержке. Возьмите инициативу, помогите нашему сообществу, став волонтером или партнером Умут булагы.",
